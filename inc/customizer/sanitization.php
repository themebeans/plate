 ...
 */
function plate_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function plate_sanitize_css( $css ) {
 ...
 */
function plate_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function plate_sanitize_email( $email, $setting ) {
 ...
 */
function plate_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function plate_sanitize_html( $html ) {
 ...
 */
function plate_sanitize_image( $image, $setting ) {
 ...
 */
function plate_sanitize_nohtml( $nohtml ) {
 ...
 */
function plate_sanitize_number_absint( $number, $setting ) {
...
function plate_sanitize_number_intval( $int ) {
	return intval( $int );
}
 ...
 *                    the setting default.
 */
function plate_sanitize_number_range( $number, $setting ) {
 ...
 */
function plate_sanitize_select( $input, $setting ) {
 ...
 */
function plate_sanitize_url( $url ) {
